...
module.exports = function (grunt) {
  ...
  grunt.registerTask('build',['clean:before','sass','dom_munger','ngtemplates','cssmin','concat','ngAnnotate','uglify','copy','htmlmin','clean:after']);
  grunt.registerTask('serve', ['dom_munger:read', 'sass', 'cssmin', 'connect', 'watch']);
